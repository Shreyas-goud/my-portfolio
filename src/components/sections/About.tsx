    ...
    >
      ...
      >
        ...
        <motion.p className="mb-4" variants={item}>
          Software Engineer with a DevOps and Cloud foundation. Experienced in
          building responsive web applications using modern JavaScript
          frameworks and robust backend services. Skilled in cloud deployment,
          database optimization, and API design. Proven ability to deliver
          efficient, scalable solutions while maintaining high code quality and
        ...
        >
          <code className="text-pink-600 dark:text-[#ce9178]">
            const developer = {`{`}
          </code>
          <code className="block pl-4 text-blue-600 dark:text-[#9cdcfe]">
            name: "Shreyas Goud",
          </code>
          <code className="block pl-4 text-blue-600 dark:text-[#9cdcfe]">
      ...
      <motion.div variants={item}>
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-xl font-semibold dark:text-[#d4d4d4]">
            GitHub Activity
          </h2>
        </div>
        <GithubGraph
          username="Shreyas-goud"
          blockMargin={2}
